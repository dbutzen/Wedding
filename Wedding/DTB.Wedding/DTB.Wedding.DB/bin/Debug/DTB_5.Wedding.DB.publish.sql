...
BEGIN
	...
	SELECT @FamilyId from dbo.tblFamily where Name = 'Dans Maternal Grandparents'
	...
	-- Paternal Grandpa
	SELECT @FamilyId from dbo.tblFamily where Name = 'Dan Paternal Grandpa'
	INSERT INTO dbo.tblGuest 
		(Id, FamilyId, TableId, Name, NumberPlusOnes, Attendance)
	VALUES
	...
	-- Paternal Grandma
	SELECT @FamilyId from dbo.tblFamily where Name = 'Dan Paternal Grandma'
	INSERT INTO dbo.tblGuest 
		(Id, FamilyId, TableId, Name, NumberPlusOnes, Attendance)
	VALUES
	...
	-- Parents
	SELECT @FamilyId from dbo.tblFamily where Name = 'Dan Parents'
	INSERT INTO dbo.tblGuest 
		(Id, FamilyId, TableId, Name, NumberPlusOnes, Attendance)
	VALUES
